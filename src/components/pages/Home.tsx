        ...
        <div className="container-custom text-center">
          <div className="max-w-4xl mx-auto space-y-6 lg:space-y-8 pt-8 lg:pt-16 px-4">
            ...
            <div className="flex justify-center pt-6 lg:pt-8 pb-6 lg:pb-8">
              <Button
                href="#"
                className="luxury-shimmer !bg-white !text-forest px-8 lg:px-12 py-4 lg:py-6 rounded-sm uppercase font-bold tracking-wider text-lg lg:text-xl transition-all duration-300 hover:!bg-white hover:!text-forest"
              >
                Book Your Free Consultation
              </Button>
            </div>
